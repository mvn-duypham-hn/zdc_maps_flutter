...
class PaddingPage extends ZdcMapExampleAppPage {
...
class MarkerIconsBodyState extends State<MarkerIconsBody> {
  ZdcMapController? controller;

  EdgeInsets _padding = EdgeInsets.zero;

  @override
  Widget build(BuildContext context) {
    final ZdcMap zdcMap = ZdcMap(
  ...
  void _onMapCreated(ZdcMapController controllerParam) {
    setState(() {
