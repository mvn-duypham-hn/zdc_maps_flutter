...
///
/// Pass to [ZdcMap.onMapCreated] to receive a [ZdcMapController] when the
/// map is created.
typedef MapCreatedCallback = void Function(ZdcMapController controller);
...
class ZdcMap extends StatefulWidget {
  ...
  /// Callback method for when the map is ready to be used.
  ///
  /// Used to receive a [ZdcMapController] for this [ZdcMap].
  ...
  /// Called every time a [ZdcMap] is tapped.
  final ArgumentCallback<LatLng>? onTap;

  /// Called every time a [ZdcMap] is long pressed.
  ...
  /// Creates a [State] for this [ZdcMap].
  @override
...
class _ZdcMapState extends State<ZdcMap> {
  ...
  final Completer<ZdcMapController> _controller =
  Completer<ZdcMapController>();
  ...
  Future<void> _disposeController() async {
    final ZdcMapController controller = await _controller.future;
    controller.dispose();
  }

  @override
  void didUpdateWidget(ZdcMap oldWidget) {
  ...
  Future<void> onPlatformViewCreated(int id) async {
    final ZdcMapController controller = await ZdcMapController.init(
      id,
...
MapConfiguration _configurationFromMapWidget(ZdcMap map) {
